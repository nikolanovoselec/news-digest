...
// and REQ-PIPE-001 (scheduled generation via cron dispatcher).
...
describe('localDateInTz', () => {
  ...
  it('REQ-PIPE-001: returns next local date when UTC is late and tz is ahead of UTC', () => {
  ...
  it('REQ-PIPE-001: output is YYYY-MM-DD format (10 chars, two hyphens)', () => {
...
describe('localHourMinuteInTz', () => {
  ...
  it('REQ-PIPE-001: preserves minutes across timezone conversion', () => {
