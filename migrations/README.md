...
| 0007 | `0007_scrape_chunk_completions.sql` | Per-chunk completion ledger for REQ-PIPE-006 idempotency (chunk-vs-finalize race guard) |
| 0008 | `0008_scrape_runs_finalize_lock.sql` | `scrape_runs.finalize_enqueued` once-per-run gate (REQ-PIPE-008 AC 6) |
| 0009 | `0009_refresh_tokens.sql` | Refresh-token rotation table for REQ-AUTH-008 |
| 0010 | `0010_scrape_runs_finalize_recorded.sql` | `scrape_runs.finalize_recorded` once-per-run dedup-merge gate (REQ-PIPE-008 AC 9) |
